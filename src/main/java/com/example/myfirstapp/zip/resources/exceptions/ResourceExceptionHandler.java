package com.example.myfirstapp.zip.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    @ExceptionHandler(IllegalArgumentException.class) // NOVO EXCEPTION HANDLER
    public ResponseEntity<StandardError> illegalArgument(IllegalArgumentException e, HttpServletRequest request) {
        String error = "Bad request data";
