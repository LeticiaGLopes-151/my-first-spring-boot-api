package com.example.myfirstapp.zip.config;
...
import com.example.myfirstapp.zip.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Product p3 = new Product(null, "Macbook Pro", "Nam eleifend cursus elit vitae malesuada.", 1250.0, "");
